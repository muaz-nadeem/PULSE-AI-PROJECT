...
"[project]/app/api/extension/tabs/analytics/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        let query = supabase.from("tab_analytics").select("*").eq("user_id", user.id).order("time_spent", {
            ascending: false
        }).limit(limit);
        if (startDate) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5127bc65._.js.map