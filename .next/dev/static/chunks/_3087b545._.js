...
const authAPI = {
    ...
    async register (email, name, password) {
        ...
        if (!data.session) {
            ...
            const { data: signInData, error: signInError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email: normalizedEmail,
                password: password
            });
        ...
        const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("users").update({
            name
        }).eq("id", data.user.id);
        if (updateError) {
    ...
    logout () {
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signOut();
    }
};
const usersAPI = {
    async getCurrentUser () {
        // First check session
        const { data: { session }, error: sessionError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
        if (sessionError || !session) {
            throw new Error("Not authenticated");
        }
        const user = session.user;
        // Try to get user profile, but handle case where it might not exist yet
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("users").select("email, name, onboarding_completed").eq("id", user.id).single();
        // If user profile doesn't exist yet, create it
        if (error && error.code === 'PGRST116') {
            // Profile doesn't exist, create it
            const { error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("users").insert({
                id: user.id,
                email: user.email || "",
    ...
    async updateCurrentUser (data) {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("users").update(updates).eq("id", user.id);
        if (error) {
...
const tasksAPI = {
    async getAll () {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("tasks").select("*").eq("user_id", user.id).order("created_at", {
            ascending: false
        });
        if (error) {
            handleSupabaseError(error);
    ...
    async getById (id) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("tasks").select("*").eq("id", id).eq("user_id", user.id).single();
        if (error) {
            handleSupabaseError(error);
        }
        return {
    ...
    async create (data) {
        ...
        const { data: task, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("tasks").insert({
            user_id: user.id,
            title: data.title,
            description: data.description || "",
            priority: data.priority,
    ...
    async update (id, data) {
        ...
        const { data: task, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("tasks").update(updates).eq("id", id).eq("user_id", user.id).select().single();
        if (error) {
            handleSupabaseError(error);
        }
        return {
    ...
    async delete (id) {
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("tasks").delete().eq("id", id).eq("user_id", user.id);
        if (error) {
            handleSupabaseError(error);
        }
    }
...
const focusSessionsAPI = {
    async getAll () {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("focus_sessions").select("*").eq("user_id", user.id).order("created_at", {
            ascending: false
        });
        if (error) {
            handleSupabaseError(error);
    ...
    async create (data) {
        ...
        const { data: session, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("focus_sessions").insert({
            user_id: user.id,
...
"[project]/lib/store-sync.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function syncStoreWithAPI() {
    try {
        // Sync tasks
        try {
            const tasks = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["tasksAPI"].getAll();
        ...
        // Sync focus sessions
        try {
            const sessions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["focusSessionsAPI"].getAll();
...
"[project]/lib/ai/gemini.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const apiKey = ("TURBOPACK compile-time value", "AIzaSyBQqqItYS27Wxp0ECMxfxwwjUET1aNmifQ") || "";
if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
;
const genAI = ("TURBOPACK compile-time truthy", 1) ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$google$2f$generative$2d$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GoogleGenerativeAI"](apiKey) : "TURBOPACK unreachable";
...
"[project]/lib/ai/schedule-generator.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$gemini$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/ai/gemini.ts [app-client] (ecmascript)");
;
async function generateDailySchedule({ tasks, mood, moodNotes, focusDuration = 25, weeklySchedule: weeklySchedule1 = [] }) {
    try {
        const model = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$gemini$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGeminiModel"])();
        ...
        const classScheduleContext = weeklySchedule1.length > 0 ? `\n\nToday's Class Schedule (DO NOT schedule tasks during these times):\n${weeklySchedule1.map((cls)=>`- ${cls.time}: ${cls.className}`).join("\n")}` : "\n\nNo classes scheduled for today.";
        // Build mood context
        const moodContext = mood ? `Current Mood: ${mood}${moodNotes ? ` (${moodNotes})` : ""}` : "No mood logged for today";
        // Create the prompt
...
- Account for lunch break from 13:30-14:30 (1:30 PM - 2:30 PM)`;
        ...
        const schedule = parsed.schedule.map((item)=>{
            ...
            return {
                time: item.time,
                duration: Math.max(15, Math.min(item.duration || 30, 240)),
...
function generateFallbackSchedule(tasks, focusDuration) {
    ...
    const conflictsWithClass = (startMinutes, duration)=>{
        const endMinutes = startMinutes + duration;
        return blockedTimes.some((block)=>startMinutes >= block.start && startMinutes < block.end || endMinutes > block.start && endMinutes <= block.end || startMinutes < block.start && endMinutes > block.end);
    };
    // Helper to find next available time slot
    const findNextAvailableTime = (startMinutes, duration)=>{
        let currentTime = startMinutes;
        while(conflictsWithClass(currentTime, duration) && currentTime < 19 * 60){
            // Find the end of the conflicting class
            const conflictingClass = blockedTimes.find((block)=>currentTime >= block.start && currentTime < block.end || currentTime < block.start && currentTime + duration > block.start);
            if (conflictingClass) {
    ...
    for(let i = 0; i < Math.min(incompleteTasks.length, 8); i++){
        ...
        if (currentTime >= 13 * 30 && schedule.findIndex((s)=>s.task.toLowerCase().includes("lunch")) === -1) {
...
"[project]/lib/ai/coach.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$gemini$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/ai/gemini.ts [app-client] (ecmascript)");
;
async function getCoachResponse(userMessage, context) {
    try {
        const model = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$ai$2f$gemini$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getGeminiModel"])();
        ...
        // Build task summary
        const taskSummary = incompleteTasks.length > 0 ? incompleteTasks.slice(0, 5).map((t)=>`- ${t.title} (${t.priority} priority${t.dueDate ? `, due: ${t.dueDate}` : ""})`).join("\n") : "No pending tasks";
        // Build habit summary
        const activeHabits = context.habits.filter((h)=>h.completedDates.length > 0);
        const habitSummary = activeHabits.length > 0 ? activeHabits.slice(0, 3).map((h)=>`- ${h.name} (${h.currentStreak} day streak)`).join("\n") : "No active habits";
...
${context.recentMessages && context.recentMessages.length > 0 ? context.recentMessages.slice(-3).join("\n") : "This is the start of the conversation."}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/store.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2d$sync$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/store-sync.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/api.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/client.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$auth$2d$welcome$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/auth-welcome.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$day$2d$planner$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/day-planner.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$analytics$2d$dashboard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/analytics-dashboard.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$settings$2d$page$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/settings-page.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$coach$2d$panel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/coach-panel.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$task$2d$manager$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/task-manager.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$mood$2d$tracker$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/mood-tracker.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$blocking$2d$settings$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/blocking-settings.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$goals$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/goals.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$distraction$2d$log$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/distraction-log.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$challenges$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/challenges.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$time$2d$block$2d$calendar$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/time-block-calendar.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$focus$2d$sounds$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/focus-sounds.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$reports$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/reports.tsx [app-client] (ecmascript)");
...
function Home() {
    ...
    const { auth, setAuth, currentPage, isMobileMenuOpen, setMobileMenuOpen } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])();
    const [isOnboarded, setIsOnboarded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null) // null = loading, false = not onboarded, true = onboarded
    ;
    const [isCheckingAuth, setIsCheckingAuth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true) // Track if we're still checking auth
    ;
    const [hasSetInitialPage, setHasSetInitialPage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false) // Track if we've set initial page
    ;
            ...
            const checkAuth = {
                "Home.useEffect.checkAuth": async ()=>{
                    ...
                    try {
                        ...
                        try {
                            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usersAPI"].getCurrentUser();
                            if (isMounted) {
                                if (user && user.email) {
                                    ...
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2d$sync$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["syncStoreWithAPI"])().catch({
                                        "Home.useEffect.checkAuth": (syncError)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (auth.isAuthenticated && isOnboarded && !isCheckingAuth && !hasSetInitialPage) {
                const { setCurrentPage, currentPage: storeCurrentPage } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"].getState();
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$onboarding$2d$flow$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            onComplete: async ()=>{
                try {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usersAPI"].updateCurrentUser({
                        onboarding_completed: true
                    });
                    setIsOnboarded(true);
                    // Ensure we're on dashboard after onboarding
                    const { setCurrentPage } = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"].getState();
                    setCurrentPage("dashboard");
                } catch (error) {
...
_s(Home, "JHk+bHlksjMfOx23WxXG0RW08pE=", false, function() {
    return [
...
//# sourceMappingURL=_3087b545._.js.map