...
export default function CoachPanel() {
  ...
  useEffect(() => {
    ...
    setMessages([
      {
        id: "1",
        text: "Hey! 👋 I'm your AI Productivity Coach powered by Gemini. I've analyzed your productivity patterns and I'm here to help you stay focused and achieve your goals. How can I help you today?",
        sender: "coach",
              ...
              <p className="text-sm text-muted-foreground">
                {completedCount === totalTasks && totalTasks > 0
                  ...
                  : highPriorityTasks.length > 0
                    ...
                    : "I learn from your interactions! The more you chat with me, the better I'll understand your work style and provide personalized advice."}
              </p>
            </div>
          </div>
        </Card>
